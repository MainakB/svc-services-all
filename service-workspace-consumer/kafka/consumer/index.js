...
module.exports = function (groupdata, topicsObj, consumer) {
  ...
  consumer.on("data", async (data) => {
    ...
    try {
      ...
      if (groupdata.topicname === topicsObj.topics.topic_updateWorkspace) {
        const dataModified = { ...dataToSend };
        await jobWorkers.addTeamCiTenant(dataModified);

        console.log(
          "Workspace added. Produce next event: ",
          groupdata.forwardTopic
        );
